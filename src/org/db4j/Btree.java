    ...
    extends Hunkable<Btree> implements Serializable
{
     ...
     */
    void insert1(CC context) throws Pausable {
        initContext(context);
...
//        insert(path.page,context,path.ko);
     ...
     */
    public void remove(Path<PP> path,CC context,boolean right) throws Pausable {
        PP page = path.page;
...
//        System.out.format( "Btree.remove -- page:%5d num:%5d, %5d %5d %5d\n", page.kpage, page.num, size, s2, so );
    ...
    public abstract PP getPage(int kpage,CC cc,boolean leaf) throws Pausable;
    /** create a new page */
    public abstract PP createPage(boolean leaf,CC context) throws Pausable;
    ...
    static abstract class DirectMap<CC extends Context>
        ...
        public Sheet getPage(int kpage,CC cc,boolean leaf) throws Pausable { return pages.vo[kpage]; }
        /** create a new page */
        public Sheet createPage(boolean leaf,CC context) throws Pausable {
            int index;
    ...
    public void dump(PP page,String prefix,CC cc,int level,int num) throws Pausable {
        if (num==0) return;
